							...
							<>
								<div className="flex flex-col">
									...
									<Section collapsible defaultOpen={false}>
										<SectionHeader>
											<SectionTitle>画质质量</SectionTitle>
										</SectionHeader>
										<SectionContent>
											<RadioGroup
												value={quality}
											...
											>
												<div className="flex items-center space-x-2">
													...
													<Label htmlFor="low">较低 - 体积最小</Label>
												</div>
												<div className="flex items-center space-x-2">
													<RadioGroupItem value="medium" id="medium" />
													<Label htmlFor="medium">中等 - 平衡推荐</Label>
												</div>
												<div className="flex items-center space-x-2">
													<RadioGroupItem value="high" id="high" />
													<Label htmlFor="high">高清 - 画面更清晰</Label>
												</div>
												<div className="flex items-center space-x-2">
									...
									<Section collapsible defaultOpen={false}>
										<SectionHeader>
											<SectionTitle>音频输出</SectionTitle>
										</SectionHeader>
										<SectionContent>
											<div className="flex items-center space-x-2">
												<Checkbox
