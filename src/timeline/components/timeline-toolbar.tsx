...
export function TimelineToolbar({
	...
	return (
		<ScrollArea className="scrollbar-hidden">
			<div className="flex h-10 items-center justify-between border-b px-2 py-1 select-none">
				<ToolbarLeftSection />
	...
	return (
		<div className="flex items-center gap-1">
			<TooltipProvider delayDuration={500}>
				...
				<ToolbarButton
					icon={<HugeiconsIcon icon={ScissorIcon} className="size-4 text-primary" />}
					tooltip="分割片段 (S / Ctrl+B)"
				...
				<Tooltip>
					<ToolbarButton
						...
						tooltip={isCurrentlyBookmarked ? "移除时间标记" : "添加时间标记"}
						onClick={({ event }) =>
	...
	return (
		<div>
			<SplitButton className="border-foreground/10 border">
				<SplitButtonLeft>{currentScene?.name || "默认场景"}</SplitButtonLeft>
				<SplitButtonSeparator />
				<ScenesView>
